  ...
  <!--<![endif]-->
    ...
    <div class="content" margin-left="0px">
        <div class="header">
            ...
            <h1 class="page-title" style="font-size: 30px">“Businex”管理员列表</h1>
...
<table class="table">
  ...
  <s:iterator value="#alist">
    ...
    <td><s:property value="id"/></td>
      ...
      <td>
         <a href="admin_doDeleteAdmin.action?id=${id }&&loginedId=${loginedAdmin.id}">删除<i class="fa fa-trash-o"></i></a>
...
<s:if test="keyword!=null">
  <li><s:if test="pageNum>1"><a href="admin_doSearchSome.action?keyword=${keyword }&pageNum=<s:property value="pageNum-1"/>">&laquo;</a> </s:if></li>
...
<li>	<s:iterator begin="1" end="#pageCount" var="n">
    			...
    			<s:else>
    				<a href="admin_doSearchSome.action?keyword=${keyword }&pageNum=<s:property/>"><s:property/></a>
    			</s:else>
    		</s:iterator>
 </li>
  ...
  <li>
  	<s:if test="pageNum<#pageCount">
  			<a href="admin_doSearchSome.action?keyword=${keyword }&pageNum=<s:property value="pageNum+1"/>">&raquo;</a> 
  	 </s:if>
 </li>
</s:if>
	...
	<s:else>
  <li><s:if test="pageNum>1"><a href="admin_doSearchAll.action?pageNum=<s:property value="pageNum-1"/>">&laquo;</a> </s:if></li>
...
<li>	<s:iterator begin="1" end="#pageCount" var="n">
  ...
  <li>
  	<s:if test="pageNum<#pageCount">
  			<a href="admin_doSearchAll.action?pageNum=<s:property value="pageNum+1"/>">&raquo;</a> 
  	 </s:if>
 </li>
</s:else>
</ul>
