...
<body class=" theme-blue"  margin-left="0px">
  ...
  <!--<![endif]-->
    ...
    <div class="content" margin-left="0px">
        <div class="header">
            <h1 class="page-title" style="font-size: 30px">“Businex”评论信息列表</h1>
  ...
  <tr>
			<td height="32" colspan="6">
				<form action="comment_list.action" method="post" name="f1">
					按评论人查询：<input type="text" name="keyword" /> <input type="submit"
						name="sub" value="查找" />
				</form>
			</td>
		</tr>
  ...
  <s:iterator value="#commentList">
    <tr>
      ...
      <td><a href="###" onclick="javascritp:showDetial(${cmid });"><img src="images/search.gif" width="16" height="16" />查看</a>&nbsp;&nbsp;
		<a href="comment_delete.action?cmid=${cmid }">删除<i class="fa fa-trash-o"></i></a>
	  </td>
    </tr>
   </s:iterator>
  </tbody>
...
<li><s:if test="pageNum>1"><a href="comment_list.action?keyword=${keyword }&pageNum=<s:property value="pageNum-1"/>">&laquo;</a> </s:if></li>
...
<li>	<s:iterator begin="1" end="#pageCount" var="n">
    			...
    			<s:else>
    				<a href="acomment_list.action?keyword=${keyword }&pageNum=<s:property/>"><s:property/></a>
    			</s:else>
    		</s:iterator>
 </li>
  ...
  <li>
  	<s:if test="pageNum<#pageCount">
  			<a href="comment_list.action?keyword=${keyword }&pageNum=<s:property value="pageNum+1"/>">&raquo;</a> 
  	 </s:if>
 </li>
