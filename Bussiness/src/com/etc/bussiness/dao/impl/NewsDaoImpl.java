...
public class NewsDaoImpl extends BaseDao implements NewsDao {
	...
	public List<News> getNewsByPaging(int pageNum, int pageSize) {
		...
		return super.searchByPaging("from News n order by n.newsTime desc", null, pageSize, pageNum);
	}
	...
	public List<News> getNewsByPaging(int pageNum, int pageSize, String keyword) {
		String hql = "from News n where n.newsTitle like :keyword order by n.newsTime desc";
